...
import 'package:oop/presentation/views/cart.dart';
import 'package:oop/presentation/views/home.dart';
import 'package:oop/presentation/views/profile.dart';
...
class BottomNavBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<PersistentTabConfig> tabs = [
      ...
      PersistentTabConfig(screen: const Profile(), item: ItemConfig(icon: const Icon(Icons.person), title: 'Profile'))
    ];
