...
class StyleBottomNavBar extends StatelessWidget {
  ...
  Widget _buildItem(ItemConfig item, bool isSelected, BuildContext context) =>
      AnimatedContainer(
        width: isSelected ? 23.w : 50,
        height: isSelected ? 6.h : 50,
        ...
        child: Row(
          ...
          children: <Widget>[
            IconTheme(
              data:
                  IconThemeData(size: item.iconSize, color: const Color(0xFFcaa49f)),
              ...
              Flexible(
                child: Padding(
                  ...
                  child: FittedBox(
                    child: Text(
                      item.title!,
                      style: item.textStyle.apply(color: const Color(0xFFcaa49f)),
                    ),
                  ),
                ),
              ),
  ...
  Widget build(BuildContext context) => DecoratedNavBar(
        ...
        opacity: navBarDecoration.color!.opacity,
        height: 9.h,
        child: Row(
          ...
          children: navBarConfig.items.map((item) {
            ...
            return GestureDetector(
              ...
              child: _buildItem(
                  item, navBarConfig.selectedIndex == index, context),
            );
          }).toList(),
        ),
      );
